...
namespace Eternal
{
	namespace Tasks
	{
		...
		WindowsAutoRecompileShaderTask::WindowsAutoRecompileShaderTask(_In_ const TaskCreateInformation& InTaskCreateInformation, _In_ GraphicsContext& InContext)
			: AutoRecompileShaderTask(InTaskCreateInformation, InContext)
		{
		...
		WindowsAutoRecompileShaderTask::~WindowsAutoRecompileShaderTask()
		{
			delete _AutoRecompileShaderData;
			_AutoRecompileShaderData = nullptr;
		}

		void WindowsAutoRecompileShaderTask::DoExecute()
		{
