#ifndef _GRAPHIC_GAME_OBJECT_GAME_DATA_HPP_
#define _GRAPHIC_GAME_OBJECT_GAME_DATA_HPP_
...
namespace Eternal
{
	namespace GameData
	{
		...
		class GraphicGameObjectGameData : public TemplatedGameData<GraphicGameObject>
		{
		public:
			GraphicGameObjectGameData(_In_ GraphicGameObject& GameObject);
